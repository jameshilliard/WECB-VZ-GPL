...
struct net_bridge_fdb_entry
{
    ...
    char          live_ticks;
    unsigned char          live_ticks_pad[3];
#endif
};


#ifdef CONFIG_BR_IP_MAC_MAPPING
struct br_ip_mac_map_entry
{
    struct hlist_node   hlist;
    struct rcu_head     rcu;
    mac_addr            addr;
...
struct br_ip_mac_map_netlink_entry
{
...
#ifdef CONFIG_BR_IP_MAC_MAPPING
/*#32287*/
extern void br_fdb_update_ip_addr(const struct net_bridge *br, const struct sk_buff *skb);
#endif
