...
MIBDEF(unsigned char,   mp_serial_num, [14+1], MP_SERIAL_NUM, STRING_T, APMIB_T, 0, 0)
#if defined(AEI_WECB)
MIBDEF(unsigned char,   wlan_wsc_pin, [8+1], WLAN_WSC_PIN, STRING_T, APMIB_T, 0, 0)
#endif
...
#if defined(AEI_WECB)
MIBDEF(unsigned char,   uapsdEnable, , UAPSD_ENABLED, BYTE_T, CONFIG_WLAN_SETTING_T, 0, 0)
#endif
