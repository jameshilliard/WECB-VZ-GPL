...
#ifdef ACTIONTEC_WCB
#define COUNTDOWN_PAGE "/wcb_countdown.html"
#else
...
#ifdef AEI_WECB
extern int aei_get_flash_data(AEI_FLASH_DATA_T *addr, unsigned long image);
extern int aei_swap_img(void);
#endif
...
/* Routines exported in act_wcb.c */
#if defined(ACTIONTEC_WCB)
extern int actInclude(request *wp, int argc, char **argv);
extern int actValue(request *wp, int argc, char **argv);
extern int actTable(request *wp, int argc, char **argv);

extern void actWlwac(request *wp, char *path, char *query);
extern void actWlbasic(request *wp, char *path, char *query);
extern void actWlsecurity(request *wp, char *path, char *query);
extern void actWlssid(request *wp, char *path, char *query);
extern void actWlwfps(request *wp, char *path, char *query);
extern void actWladv(request *wp, char *path, char *query);
extern void actWlnetwork(request *wp, char *path, char *query);

extern void actAdvdefault(request *wp, char *path, char *query);
extern void actAdvSwapImage(request *wp, char *path, char *query);
extern void actGetImageVersion(request *wp, char *path, char *query);
extern void actAdvreboot(request *wp, char *path, char *query);
extern void actAdvmanage(request *wp, char *path, char *query);
extern void actAdvtr69(request *wp, char *path, char *query);
extern void actgetCurrentAddrInfo(request *wp, char *path, char *query);
extern void actPassword(request *wp, char *path, char *query);
extern void actUserlogin(request *wp, char *path, char *query);
extern void actUserlogout(request *wp, char *path, char *query);
extern void actLogincheck(request *wp, char *path, char *query);
extern void actMocasetup(request *wp, char *path, char *query);
#endif
