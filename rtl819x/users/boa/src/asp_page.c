...
asp_name_t root_asp[] = {
    ...
    {"actZeroConfNotify", actZeroConfNotify},
#endif
	{NULL, NULL}
};
...
form_name_t root_form[] = {
	...
	{"wlwac", actWlwac},
	{"wlbasic", actWlbasic},
	{"wlsecurity", actWlsecurity},
	{"wlssid", actWlssid},
	{"wlwfps", actWlwfps},
	{"wladv", actWladv},
	{"wlnetwork", actWlnetwork},
	{"advdefault", actAdvdefault},
	{"advswapimage", actAdvSwapImage},
	{"getimageversion", actGetImageVersion},
	{"advreboot", actAdvreboot},	
	{"advmanage", actAdvmanage},
	{"getcuraddr", actgetCurrentAddrInfo},	
	{"advpassword", actPassword},
	{"userlogin", actUserlogin},
	{"userlogout", actUserlogout},	
	{"logincheck", actLogincheck},
	{"mocasetup", actMocasetup},
	{"advtr69",actAdvtr69},
#endif
	{NULL, NULL}
};
...
int update_content_length(request *req)
{
	...
	*/
	...
	if(atoi(buff) != exact_content_len) {
		...
		if (strlen(buff) <= orig_char_length)
