...
#ifdef AEI_WECB
#define ACTIONTEC_WCB
#endif

#define ACTIONTEC_MULTIACCESS
//#define ACTIONTEC_CLIENT

#ifdef AEI_WIFI_CERT
#define ACTIONTEC_WIFI_CERTIFICATED
#endif

// for wireless tr69 set value to tr69 server
#define ACTIONTEC_TR69

#ifdef AEI_DATACENTER
#define ACTIONTEC_DATACENTER
#endif

#ifdef AEI_USERPWD_MD5
#define ACTIONTEC_MD5
#endif
...
#define MAX_UPLOAD_SIZE	400000		// davidhsu
